...
class KnowledgeGraph(nn.Module):
    ...
    def vectorize_action_space(self, data_dir):
        ...
        if self.args.use_action_space_bucketing:
            ...
            action_space_list = [] # (num_entities, action_space_size_per_entity)
            max_num_actions = 0
            for e1 in range(self.num_entities):
                action_space = get_action_space(e1)
            ...
            #  r_sapce: (num_entities, action_space_size_per_entity). [2,3,4,6,5,padding,...]
            #  e_space: (num_entities, action_space_size_per_entity). [13,12,33,454,6,padding,...]
            #  action_mask: (num_entities, action_space_szie_per_entity). [1,1,1,1,1,0,...]
