...
class LFramework(nn.Module):
    ...
    def run_train(self, train_data, dev_data):
        ...
        for epoch_id in range(self.start_epoch, self.num_epochs):
            ...
            if self.run_analysis or (epoch_id > 0 and epoch_id % self.num_peek_epochs == 0):
                ...
                print('Dev set performance: (correct evaluation)') # dev_data: list of (h,r,t)
    ...
    def forward(self, examples, verbose=False):
        ...
        return scores # (len_dev_set, num_entities)
    ...
    def format_batch(self, batch_data, num_labels=-1, num_tiles=1):
        ...
        for i in range(len(batch_data)):
            ...
            batch_e2.append(e2)
            batch_r.append(r)
        batch_e1 = var_cuda(torch.LongTensor(batch_e1), requires_grad=False) # (batch_size)
        batch_r = var_cuda(torch.LongTensor(batch_r), requires_grad=False) # (batch_size)
        ...
        return batch_e1, batch_e2, batch_r # (batch_size*num_tiles)
